...
NORM_0_BN_BN = ++model.kwargs.norm_layer.0.path=torch.nn.Identity

ROBARCH_S = ++model.kwargs.depths=[5,8,13,1] ++model.kwargs.stage_widths=[288,576,1120,2160] ++model.kwargs.group_widths=[36,72,140,270] $(MOVE_DOWN_DOWNSAMPLE_1) $(STEM_WIDTH_96) $(SE_0_25_RELU) $(ACT_SILU_SILU_SILU) $(NORM_0_BN_BN)
ROBARCH_M = ++model.kwargs.depths=[7,11,18,1] ++model.kwargs.stage_widths=[336,672,1328,2624] ++model.kwargs.group_widths=[42,84,166,328] $(MOVE_DOWN_DOWNSAMPLE_1) $(STEM_WIDTH_96) $(SE_0_25_RELU) $(ACT_SILU_SILU_SILU) $(NORM_0_BN_BN)
ROBARCH_L = ++model.kwargs.depths=[7,11,18,1] ++model.kwargs.stage_widths=[512,1024,2016,4032] ++model.kwargs.group_widths=[64,128,252,504] $(MOVE_DOWN_DOWNSAMPLE_1) $(STEM_WIDTH_96) $(SE_0_25_RELU) $(ACT_SILU_SILU_SILU) $(NORM_0_BN_BN)
